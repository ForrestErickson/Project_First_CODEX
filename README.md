...
5. Add WiFi Manager and OTA (use libraries tzapu/WiFiManager@^2.0.17 ayushsharma82/ElegantOTA@^3.1.7)
6. Add MQTT PubSub  (use knolleary/PubSubClient@^2.8). Set Broker to "mqtt://public:public@public.cloud.shiftr.io". Publish to "F4650BBB3EDC_ALM" and Subscribe to "F4650BBB3EDC_ACK"
7. Make Boot Button (GPIO0) Publish a payload "a1Lee is in Discord" (Use for debounce libraries cygig/DailyStruggleButton@^0.5.1)
